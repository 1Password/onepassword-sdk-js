...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h8ae6f7a0c7132e8c: (a: number, b: number) => void;
export const closure2378_externref_shim: (a: number, b: number, c: any) => void;
export const closure2466_externref_shim: (a: number, b: number, c: any, d: any) => void;
