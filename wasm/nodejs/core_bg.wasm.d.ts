...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h68df64fb5d0daf52: (a: number, b: number) => void;
export const closure2750_externref_shim: (a: number, b: number, c: any) => void;
export const closure2838_externref_shim: (a: number, b: number, c: any, d: any) => void;
